...
-- MAGIC %python
-- MAGIC dailyPricingStramingSourceFolderPath = "abfss://bronze@madhupavanadls.dfs.core.windows.net/daily-pricing-streaming-source-data"
...
-- MAGIC FROM bronze.daily_pricing_tbl
